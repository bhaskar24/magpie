...
HBASE_PACKAGE="hbase/1.4.0/hbase-1.4.0-bin.tar.gz"
...
SPARK_PACKAGE="spark/spark-2.2.1/spark-2.2.1-bin-hadoop2.7.tgz"
SPARK_HADOOP_PACKAGE="hadoop/common/hadoop-2.7.3/hadoop-2.7.3.tar.gz"
STORM_PACKAGE="storm/apache-storm-1.1.0/apache-storm-1.1.0.tar.gz"
PHOENIX_PACKAGE="phoenix/apache-phoenix-4.13.1-HBase-1.3/bin/apache-phoenix-4.13.1-HBase-1.3-bin.tar.gz"
PHOENIX_HBASE_PACKAGE="hbase/1.3.1/hbase-1.3.1-bin.tar.gz"
KAFKA_PACKAGE="kafka/0.9.0.0/kafka_2.11-0.9.0.0.tgz"
ZEPPELIN_PACKAGE="zeppelin/zeppelin-0.7.3/zeppelin-0.7.3-bin-all.tgz"
